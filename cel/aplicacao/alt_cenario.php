...
//              justificativa para a alteração feita.
    ...
    <? $result['episodios'] = preg_replace("'<[\/\!]*?[^<>]*?>'si", "", $result['episodios']); ?>
                    ...
                    <tr>
                        <td colspan="2"><b><small>Essa justificativa ï¿½ necessï¿½ria 
                                    apenas para aqueles usuï¿½rios que 
                                    nï¿½o sï¿½o administradores.</small></b></td>
                    </tr>

                    <tr>
                        <td align="center" colspan="2" height="60"><input 
                                name="submit" type="submit" value="Alterar Cenï¿½rio" 
                                onClick="updateOpener()"></td>
                    </tr>
                </table>
            </form>
        <center><a href="javascript:self.close();">Fechar</a></center>
        <br><i><a href="showSource.php?file=alt_cenario.php">Veja o cï¿½digo fonte!</a></i>
    </body>
    </html>
